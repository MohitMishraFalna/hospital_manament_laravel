                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" method="POST" name="form_validation" action="{{route('testCreate')}}">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control test_type" id="test_type" name="test_price">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control range" id="range" name="range" placeholder="start range">
